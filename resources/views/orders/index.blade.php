    ...
    <div class="page-breadcrumb">
        <div class="row align-items-center">
            ...
            <div class="col-6 text-end d-flex gap-2 justify-content-end">
                ...
                <a href="{{ route('orders.export') }}" class="btn btn-outline-success btn-sm">Export (.xlsx)</a>
            </div>
        </div>
    </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('print', $item->id) }}" class="btn btn-info btn-sm text-white">Download</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        document.querySelectorAll('.view-btn').forEach(button => {
            button.addEventListener('click', function () {
                ...
                // Order Info
                document.getElementById('createdAt').textContent = new Date(order.created_at).toLocaleString();
